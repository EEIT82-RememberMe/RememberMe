...
<!--------------------------------------performer-------------------------------------------------------->
						<fieldset>
							<label>演唱者</label>
							<input type="text" name="performer" maxlength="30">
						</fieldset>
<!--------------------------------------musicContent-------------------------------------------------------->
						<fieldset>
							<label>內容</label>
							<textarea rows="6" style="font-size:25px" name="musicContent"></textarea>
						</fieldset>
<!--------------------------------------photo-------------------------------------------------------->
...
<!--------------------------------------blogLink-------------------------------------------------------->
						<fieldset style="width:60%; float:left;"> <!-- to make two field float next to one another, adjust values accordingly -->
							...
							<input type="text" style="width:92%;" name="blogLink" maxlength="50">
