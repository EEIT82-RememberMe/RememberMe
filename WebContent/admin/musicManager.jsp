    ...
    <jsp:include page="/includes/adminLeft.jsp" />
		...
		<article class="module width_full">
			<header>
				...
				<span class="head">演唱者管理區</span>
				<span class="sub1">目前資料總筆數 : ${datas} </span>
				<span class="sub2">上次更動日期 : ${s2}</span>
				<span class="sub2">
				<a class="button" href="<c:url value='/admin/createMusicData.jsp'/>">
...
<!-- 		<th>編號</th> -->
	...
	<tr class="tb_tr">
		...
		<td>${string2}</td>
		<td>
			<a href="${pageContext.request.contextPath}/admin/modifyMusicData.jsp?num=${element.number}&page=${currentPage}">	
    				<button class="edit">修改</button>
			</a>
 			<a href="${pageContext.request.contextPath}/news.controller/ModMusic?action=delete&number=${element.number}&page=${currentPage}">
