function filterSearch() {                             // Lives in an IIFE
  var $imgs = $('#gallery li');          // Get the images
  ...
  $imgs.each(function() {                 // For each image
    cache.push({                          // Add an object to the cache array
      ...
      text: $(this).attr("data-desc").trim().toLowerCase() // Its alt text (lowercase trimmed)
    });
  });

  var filter = function() {                     // Declare filter() function
